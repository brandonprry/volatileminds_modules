...
module Metasploit
  module Framework
    module LoginScanner
      class ManageEngineServiceDeskPlus < ::Metasploit::Framework::LoginScanner::HTTP
        def attempt_login(credential)
          ...
          begin
            ...
            if res.code == 302 and res.get_cookies =~ /JSESSIONID/
...
class MetasploitModule < Msf::Auxiliary
  ...
  def initialize
    super(
        'Name'           => 'ManageEngine ServiceDesk Plus Bruteforce',
        'Description'    => %q(
        This module attempts to bruteforce weak credentials on ManageEngine
...
as network credentials and high-value targets.
  ...
  def run_host(ip)
    ...
    scanner = Metasploit::Framework::LoginScanner::ManageEngineServiceDeskPlus.new(
