...
module Metasploit
  module Framework
    module LoginScanner
      class Dolibarr < ::Metasploit::Framework::LoginScanner::HTTP
        def attempt_login(credential)
          ...
          begin
            ...
            req = cli.request_cgi({
              'method' => 'POST',
              'uri' => uri + (uri[-1] == '/' ? '' : '/') + 'index.php?mainmenu=home',
              'vars_post' => {
            ...
            if res && res.body =~ /Home area - Dolibarr/
...
class MetasploitModule < Msf::Auxiliary
  ...
  def initialize
    super(
        'Name'           => 'Dolibarr ERP & CRM Bruteforce',
        'Description'    => %q(
        This module attempts to bruteforce weak credentials on a Dolibarr CRM/ERP instance.
        ...
        targets. This module attempts to bruteforce weak credentials on a Dolibarr
        instance.
  ...
  def run_host(ip)
    ...
    scanner = Metasploit::Framework::LoginScanner::Dolibarr.new(
