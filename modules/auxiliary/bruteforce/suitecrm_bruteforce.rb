...
module Metasploit
  module Framework
    module LoginScanner
      class SuiteCRM < ::Metasploit::Framework::LoginScanner::HTTP
        def attempt_login(credential)
          ...
          begin
            ...
            if res && res.headers['Location'] && res.headers['Location'] =~ /module=Home&action=index/
...
potential high value targets.
  ...
  def run_host(ip)
    ...
    scanner = Metasploit::Framework::LoginScanner::SuiteCRM.new(
