...
module Metasploit
  module Framework
    module LoginScanner
      class WebMailProUser < ::Metasploit::Framework::LoginScanner::HTTP
          ...
          begin
            ...
            req = cli.request_cgi({
              ...
              'vars_post' => {
                ...
                'IncPassword' => credential.private
              }
            })
...
class MetasploitModule < Msf::Auxiliary
  ...
  def initialize
    super(
        'Name'           => 'WebMail Pro PHP User Bruteforce',
        'Description'    => %q(
        This module attempts to bruteforce weak user accounts on WebMail Pro PHP instances.
...
organization or other sensitive information.
  ...
  def run_host(ip)
    ...
    scanner = Metasploit::Framework::LoginScanner::WebMailProUser.new(
